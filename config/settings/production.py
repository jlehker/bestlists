...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["www.todovoodoo.net"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="todovoodoo <noreply@todovoodoo.net>"
)
# https://docs.djangoproject.com/en/dev/ref/settings/#server-email
SERVER_EMAIL = env("DJANGO_SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
# https://docs.djangoproject.com/en/dev/ref/settings/#email-subject-prefix
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default="[todovoodoo]")
...
CORS_ORIGIN_WHITELIST = ["https://todovoodoo-static.sfo2.cdn.digitaloceanspaces.com"]
